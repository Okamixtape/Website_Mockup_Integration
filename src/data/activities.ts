export interface Activity {
  ...
  location: string
  neighborhoodId: string // Identifiant du quartier pour lier aux hébergements
  city: string
  region: string
  country: string
  duration: string
